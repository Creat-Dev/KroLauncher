...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "Minecraft est une liberter pour les cube", "author": "Creat" },
            { "message": "Bonjour", "author": "Creat" },
            { "message": "Si tu as un probleme en pvp utilise le bac a sable", "author": "Creat" }
        ];
